...
| `qa-annual-costs.mjs` | Berechnet einen gespeicherten Lauf aus der isolierten Demo-Fixture; prüft unveränderte Kostenwerte und PDF-Ziele, Einheiten-/Partei-/Betragsausrichtung einschließlich mehrerer Parteien, verborgene und per Tastatur erreichbare Laufkennung, Desktop-Spaltenköpfe, mobile Beschriftungen, Überlauf und Tastatur-Aufklapper bei 320/390/820/1050/1051/1440 px. | Andere Kostenkombinationen, echte Finanzdaten, PDF-Darstellung und externe Zustellung; nur lokale synthetische Daten. | `Portal parity and responsive shell` / 8699 | `qa_orakel qa-annual-costs.mjs /tmp/hausv-oracles/annual-costs 8699` |
