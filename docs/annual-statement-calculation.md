...
Technische Spezifikation der Jahresabrechnung (HAUSV-767, HAUSV-802), mit
Berechnungsversionen `1` bis `4`. Sie beschreibt
...
Läufe mit diesem neuen Schlüssel speichern Berechnungsversion **4** (mit oder
ohne Umsatzsteuerausweis). Historische Versionen 1–3 behalten ihren bisherigen
Rechenweg und akzeptieren den neuen Schlüssel nicht. Andere neue Läufe bleiben
bei 2 bzw. 3. Die Anteile werden als Vorlage ins Folgejahr kopiert. Die Daten
