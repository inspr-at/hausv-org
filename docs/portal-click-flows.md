...
Das Portfolio (`/app/verwaltung`) zeigt unter „Zuletzt“ die sechs jüngsten
fachlichen Aktivitäten der verwalteten Häuser, etwa bearbeitete Anliegen,
Termine, Dokumente oder freigegebene Jahresabrechnungen. Anmeldung,
Portalwechsel, reine Lesezugriffe und Demo-Initialisierung bleiben im
Audit-Verlauf; ohne fachliche Aktivitäten bleibt die Portfolio-Liste ruhig leer.
...
| 2 | Hausüberblick | Mieter, Bewohner, Eigentümer, Beirat, Verwalter, Admin | `/app` → eine konkrete Aufgabe oder Zusammenfassung der offenen Bereiche (Anliegen, Termine, ungelesene Aushänge), auch am Handy → passende Fachroute. Nur bei leeren Zählern erscheint der ruhige Zustand. Unterwege: nächster Termin, aktueller Aushang, offene Anliegen, Zuhause/Energie und die leise Aktion „Anliegen melden“. | Die gewählte Fachansicht öffnet direkt am relevanten Inhalt oder Arbeitsschritt. Die Aushang-Kennzahl zählt ungelesene Beiträge. |
