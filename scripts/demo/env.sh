...
demo_houses='["janusbergweg-123","grazbachgasse-14","annenstrasse-71","muenzgrabenstrasse-9","schoergelgasse-25","leonhardstrasse-3","koerblergasse-40","elisabethstrasse-12","sparbersbachgasse-58","mariatroster-strasse-101","petersgasse-7","kaiserfeldgasse-19"]'
