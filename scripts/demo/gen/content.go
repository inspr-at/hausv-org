...
func buildDemoContacts() []map[string]any {
	return []map[string]any{
		{"id": "demo-contact-lift",
			...
			"notes":      "Aufzugwartung und Liftstörungen am Janusbergweg 123. Notruf bei eingeschlossenen Personen rund um die Uhr; Standort und Liftnummer bereithalten. Fiktiver Demokontakt.",
			"active":     true,
		...
		{"id": "demo-contact-waerme",
			...
			"notes":      "Heizung, Sanitär und Wasserleitungen. Termine koordiniert Paul Sommer. Bei Wasseraustritt sofort Verwaltung und Notdienst verständigen. Fiktiver Demokontakt.",
			"active":     true,
			"created_at": "2026-09-01T09:00:00+02:00",
			"updated_at": "2026-09-01T09:00:00+02:00"},
		{"id": "demo-contact-elektrik",
			...
			"notes":      "Beleuchtung, Gegensprechanlage und Allgemeinstrom. Störungen mit Ort und betroffener Sicherung an die Verwaltung melden. Fiktiver Demokontakt.",
			"active":     true,
			"created_at": "2026-09-01T09:00:00+02:00",
			"updated_at": "2026-09-01T09:00:00+02:00"},
		{"id": "demo-contact-hausbetreuung",
			...
			"notes":      "Reinigung, Winterdienst und Grünflächen am Janusbergweg 123. Erreichbar Mo–Fr 7–16 Uhr; Hinweise zu Glätte bitte telefonisch melden. Fiktiver Demokontakt.",
			"active":     true,
			"created_at": "2026-09-01T09:00:00+02:00",
			"updated_at": "2026-09-01T09:00:00+02:00"}}
}
...
func buildDemoBallots() []map[string]any {
	return []map[string]any{
		{"id": "demo-ballot-fassade-2027",
			...
			"description": "Muster-Abstimmung: Die Fassade soll 2027 instand gesetzt werden. Die Verwaltung holt drei vergleichbare Angebote ein und legt Kosten und Bauzeiten vor einer Beauftragung zur Freigabe vor.",
		...
		{"id": "demo-ballot-ebikes",
			...
			"description": "Muster-Abstimmung: Soll die Verwaltung die technische Machbarkeit und Kosten von vier abschließbaren Ladepunkten prüfen lassen? Die Prüfung umfasst Stromversorgung, Brandschutz und eine getrennte Verbrauchserfassung. Über die Umsetzung wird anschließend gesondert entschieden.",
			"options":     []string{"Ja", "Nein", "Enthaltung"},
			"type":        "Umlaufbeschluss",
			"weighting":   "per-share",
			"quorum_ppm":  500000,
