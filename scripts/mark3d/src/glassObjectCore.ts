// Vendored from Canvas UI (React distribution), with the React wrapper
// stripped so the renderer can run from plain JS: hausv.org ships no React,
// and the create*() core never needed it.
//
// Upstream: https://canvasui.dev/docs/components/glass-object
// Registry:  https://canvasui.dev/r/glass-object-react.json
