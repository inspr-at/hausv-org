...
func TestApplyImportedPaymentsToUnitStatusesReportsAndAppliesOnlyClearMatches(t *testing.T) {
	...
	payments := []integrations.Payment{
		{TenantSlug: "demo", ExternalID: "p-1", Reference: candidates[0].Reference, Amount: integrations.MoneyAmount{Currency: "EUR", Cents: 10000}},
		{TenantSlug: "demo", ExternalID: "p-2", Reference: candidates[1].Reference, Amount: integrations.MoneyAmount{Currency: "EUR", Cents: 6000}},
		{TenantSlug: "demo", ExternalID: "p-3", Reference: duplicateReference, Amount: integrations.MoneyAmount{Currency: "EUR", Cents: 10000}},
		{TenantSlug: "demo", ExternalID: "p-4", Amount: integrations.MoneyAmount{Currency: "EUR", Cents: 10000}},
	...
	importEvents := a.auditStore.List(auditFilter{TenantSlug: "demo", Action: auditActionIntegrationImport, Limit: 10})
