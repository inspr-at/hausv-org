...
func Notes() []Note {
	return []Note{
		{Version: "260925055219.0.0", Scheme: Scheme, Date: "25. September 2026", Kind: "Verbessert", Headline: "Sichere Ladesteuerung per Telegram", Intro: "Telegram-Befehle wirken nur auf Liegenschaften, für die die verknüpfte Person berechtigt ist.", Items: []NoteItem{{Label: "Laden", Text: "Bei mehreren berechtigten Liegenschaften fragt der Bot nach; nicht verknüpfte Chats erhalten keine Hausdaten."}}},
