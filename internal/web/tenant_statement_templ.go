	...
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if data.Enabled {
			...
			for _, unit := range data.Units {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/tenant_statement.templ`, Line: 106, Col: 46}
				}
				...
				for _, lease := range unit.Leases {
					...
					templ_7745c5c3_Var5, templ_7745c5c3_Err = templ.JoinStringErrs(lease.Label)
					if templ_7745c5c3_Err != nil {
					...
					templ_7745c5c3_Var6, templ_7745c5c3_Err = templ.JoinStringErrs(lease.Scope)
					if templ_7745c5c3_Err != nil {
				...
				templ_7745c5c3_Var7, templ_7745c5c3_Err = templ.JoinURLErrs(templ.SafeURL("/app/settings/annual-statement/runs/" + data.RunID + "/rental-management"))
				if templ_7745c5c3_Err != nil {
				...
				for _, cost := range unit.Costs {
					...
					templ_7745c5c3_Var11, templ_7745c5c3_Err = templ.ResolveAttributeValue(cost.Key)
					if templ_7745c5c3_Err != nil {
					...
					templ_7745c5c3_Var12, templ_7745c5c3_Err = templ.JoinStringErrs(cost.Label)
					if templ_7745c5c3_Err != nil {
				...
				for _, lease := range unit.Leases {
					...
					templ_7745c5c3_Var13, templ_7745c5c3_Err = templ.JoinStringErrs(lease.Label)
					if templ_7745c5c3_Err != nil {
					...
					templ_7745c5c3_Var14, templ_7745c5c3_Err = templ.JoinStringErrs(lease.Scope)
					if templ_7745c5c3_Err != nil {
					...
					if lease.Contract {
						...
						for _, cost := range lease.Costs {
							...
							templ_7745c5c3_Var15, templ_7745c5c3_Err = templ.ResolveAttributeValue("contract_" + lease.ID)
							if templ_7745c5c3_Err != nil {
							...
							templ_7745c5c3_Var16, templ_7745c5c3_Err = templ.ResolveAttributeValue(cost.Key)
							if templ_7745c5c3_Err != nil {
							...
							templ_7745c5c3_Var17, templ_7745c5c3_Err = templ.JoinStringErrs(cost.Label)
							if templ_7745c5c3_Err != nil {
				...
				if unit.DeriveIssue != "" {
					...
					templ_7745c5c3_Var18, templ_7745c5c3_Err = templ.JoinStringErrs(unit.DeriveIssue)
					if templ_7745c5c3_Err != nil {
					...
					templ_7745c5c3_Var19, templ_7745c5c3_Err = templ.JoinStringErrs(unit.VATIssue)
					if templ_7745c5c3_Err != nil {
					...
					templ_7745c5c3_Var20, templ_7745c5c3_Err = templ.JoinURLErrs(templ.SafeURL(data.VATSettingsURL))
					if templ_7745c5c3_Err != nil {
					...
					templ_7745c5c3_Var21, templ_7745c5c3_Err = templ.JoinURLErrs(templ.SafeURL("/app/settings/annual-statement/runs/" + data.RunID + "/tenant-statements"))
					if templ_7745c5c3_Err != nil {
					...
					templ_7745c5c3_Var22, templ_7745c5c3_Err = templ.ResolveAttributeValue(unit.ID)
					if templ_7745c5c3_Err != nil {
					...
					templ_7745c5c3_Var23, templ_7745c5c3_Err = templ.ResolveAttributeValue(data.StatementOn)
					if templ_7745c5c3_Err != nil {
			...
			if len(data.Statements) > 0 {
				...
				for _, s := range data.Statements {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/web/tenant_statement.templ`, Line: 196, Col: 21}
					}
					...
					templ_7745c5c3_Var26, templ_7745c5c3_Err = templ.JoinStringErrs(s.Owner)
					if templ_7745c5c3_Err != nil {
					...
					templ_7745c5c3_Var27, templ_7745c5c3_Err = templ.JoinStringErrs(s.SourcePassed)
					if templ_7745c5c3_Err != nil {
					...
					templ_7745c5c3_Var28, templ_7745c5c3_Err = templ.JoinStringErrs(s.SourceRetained)
					if templ_7745c5c3_Err != nil {
					...
					if len(s.Accounts) > 0 {
						...
						for _, account := range s.Accounts {
							...
							templ_7745c5c3_Var29, templ_7745c5c3_Err = templ.JoinStringErrs(account.Names)
							if templ_7745c5c3_Err != nil {
							...
							templ_7745c5c3_Var30, templ_7745c5c3_Err = templ.JoinStringErrs(account.Result)
							if templ_7745c5c3_Err != nil {
							...
							templ_7745c5c3_Var31, templ_7745c5c3_Err = templ.JoinStringErrs(account.Amount)
							if templ_7745c5c3_Err != nil {
							...
							templ_7745c5c3_Var32, templ_7745c5c3_Err = templ.JoinURLErrs(templ.SafeURL("/app/settings/tenant-statements/" + s.ID + "/pdf?account=" + account.ID))
							if templ_7745c5c3_Err != nil {
					...
					if !s.Approved {
						...
						templ_7745c5c3_Var33, templ_7745c5c3_Err = templ.JoinURLErrs(templ.SafeURL("/app/settings/tenant-statements/" + s.ID + "/approve"))
						if templ_7745c5c3_Err != nil {
						...
						templ_7745c5c3_Var34, templ_7745c5c3_Err = templ.JoinURLErrs(templ.SafeURL("/app/settings/tenant-statements/" + s.ID + "/archive"))
						if templ_7745c5c3_Err != nil {
						...
						templ_7745c5c3_Var35, templ_7745c5c3_Err = templ.JoinURLErrs(templ.SafeURL("/app/settings/tenant-statements/" + s.ID + "/send"))
						if templ_7745c5c3_Err != nil {
						...
						var templ_7745c5c3_Var36 = []any{"button", templ.KV("primary", !tenantStatementDelivered(s)), templ.KV("ghost", tenantStatementDelivered(s))}
					...
					templ_7745c5c3_Var38, templ_7745c5c3_Err = templ.JoinURLErrs(templ.SafeURL("/app/settings/tenant-statements/" + s.ID + "/pdf"))
					if templ_7745c5c3_Err != nil {
					...
					if s.Archived && s.SendIssue != "" {
						...
						templ_7745c5c3_Var39, templ_7745c5c3_Err = templ.JoinStringErrs(s.SendIssue)
						if templ_7745c5c3_Err != nil {
					...
					if len(s.Deliveries) > 0 {
						...
						for _, d := range s.Deliveries {
							...
							templ_7745c5c3_Var40, templ_7745c5c3_Err = templ.JoinStringErrs(d.Recipient)
							if templ_7745c5c3_Err != nil {
							...
							templ_7745c5c3_Var41, templ_7745c5c3_Err = templ.JoinStringErrs(d.Time)
							if templ_7745c5c3_Err != nil {
							...
							var templ_7745c5c3_Var42 = []any{"ts-chip", templ.KV("ok", d.Status == "Gesendet"), templ.KV("warn", d.Status == "Fehlgeschlagen")}
