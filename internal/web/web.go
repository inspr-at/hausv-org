    ...
    <div class="section-inner">
      ...
      <div class="product-paths">
        <article class="product-path free" id="free">
          ...
          <div class="product-path-price"><strong>0&nbsp;€ für immer</strong><span>GNU AGPL-3.0 · Quellcode öffentlich verfügbar</span></div>
          <a class="product-path-start" href="https://github.com/inspr-at/hausv-org">Quellcode ansehen</a>
        </article>
  ...
  <section id="leistungen" class="section features-section">
    <div class="section-inner">
      ...
      <div class="feature-grid">
        ...
        <article class="feature-card"><div class="feature-visual"><img src="/assets/feature-roles.webp" width="560" height="560" alt="" loading="lazy" decoding="async"></div><div class="feature-copy"><span class="feature-number">08 · Zugriff</span><h3>Kontakte, Rollen und Rechte</h3><p>Verwaltung, Beirat, Bewohner und Eigentümer erhalten passende Zugriffe; Mitarbeiter betreuen das ganze Portfolio. Zugänge für externe Dienstleister sind vorbereitet, aber noch nicht freigeschaltet.</p></div></article>
      ...
      <details id="ausblick" class="landing-more">
        ...
        <div class="landing-more-grid">
          ...
          <div><h3>Energie: kontrolliert statt unbedacht</h3><ul><li>Aktive Steuerung nach bewusster Freigabe – in Entwicklung, Start später in diesem Jahr.</li><li>Zugänge für externe Dienstleister sind vorbereitet, aber noch nicht freigeschaltet.</li><li>Kein öffentlicher Marktplatz, kein Handel im Hintergrund.</li></ul></div>
        </div>
      </details>
    </div>
  </section>
