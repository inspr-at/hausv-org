...
var RoleMatrix = []MatrixCell{
	...
	{FamilyKey: "verwaltung", AreaKey: "overview", Grants: explicitGrants("Mandantschaft und Hauszuordnung", MatrixActionView)},
	...
	{FamilyKey: "eigentuemer", AreaKey: "overview", Grants: explicitGrants("Mandantschaft und Hauszuordnung", MatrixActionView)},
	{FamilyKey: "eigentuemer", AreaKey: "issues", Grants: explicitGrants("hausbezogene Bewohnerregel", MatrixActionView, MatrixActionCreate)},
	...
	{FamilyKey: "eigentuemer", AreaKey: "announcements", Grants: explicitGrants("veröffentlichte Hausinhalte", MatrixActionView)},
	{FamilyKey: "eigentuemer", AreaKey: "events", Grants: explicitGrants("veröffentlichte Hausinhalte", MatrixActionView)},
	...
	{FamilyKey: "eigentuemer", AreaKey: "contacts", Grants: explicitGrants("freigegebene Hauskontakte", MatrixActionView)},
	...
	}, Note: "Eigentümer; Beirat nur mit eigener Haus- oder Einheitenzuordnung"},
	...
	{FamilyKey: "bewohner", AreaKey: "overview", Grants: explicitGrants("Mandantschaft und Hauszuordnung", MatrixActionView)},
	{FamilyKey: "bewohner", AreaKey: "issues", Grants: explicitGrants("hausbezogene Bewohnerregel", MatrixActionView, MatrixActionCreate)},
	{FamilyKey: "bewohner", AreaKey: "documents", Grants: explicitGrants("für die Person freigegebene Dokumente", MatrixActionView)},
	{FamilyKey: "bewohner", AreaKey: "announcements", Grants: explicitGrants("veröffentlichte Hausinhalte", MatrixActionView)},
	{FamilyKey: "bewohner", AreaKey: "events", Grants: explicitGrants("veröffentlichte Hausinhalte", MatrixActionView)},
	...
	{FamilyKey: "bewohner", AreaKey: "contacts", Grants: explicitGrants("freigegebene Hauskontakte", MatrixActionView)},
...
var MatrixSpecialRoles = []MatrixSpecialRole{
	...
	{Label: "Technische Vertrauensperson", Area: "Energie", Actions: []MatrixAction{MatrixActionView, MatrixActionChange}, Scope: "Nur ausdrücklich freigegebener Hauszugriff; kein Haus-Schalter."},
}
