...
var expectedTenantTables = []string{
	"announcement_reads", "announcements", "annual_statement_cost_types", "annual_statement_periods", "annual_statement_receipts", "attachments", "ballots", "contacts", "documents",
