...
func TestHausv615EveryAuditActionHasGermanLabel(t *testing.T) {
	actions := []string{
		...
		store.AuditActionAnnualReceiptDelete, store.AuditActionAnnualPrepaymentSave, store.AuditActionAnnualReserveAdd, store.AuditActionAnnualRunCreate, store.AuditActionAnnualRunApprove,
