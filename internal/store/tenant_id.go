...
var tenantIDTables = []tenantIDTable{
	...
	{name: "annual_statement_reserve_entries", slugColumn: "tenant_slug"},
	...
	{name: "rental_management", slugColumn: "tenant_slug"},
	{name: "tenant_statements", slugColumn: "tenant_slug"},
	{name: "tenant_statement_approvals", slugColumn: "tenant_slug"},
